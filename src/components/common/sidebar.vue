        ...
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="d-flex align-items-center ms-4 mb-4">
                <div class="position-relative">
                    ...
                    <img class="rounded-circle" src="../../../public/assets/img/curepelogo_green.png" alt="" style="width: 40px; height: 40px;">
            ...
            <div class="navbar-nav w-100">
                ...
                <router-link to="/dashboard" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Transactions</router-link>
                <router-link to="/dashboard" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Health Checkup</router-link>
                <router-link to="/dashboard" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Loan Request</router-link>
                <div class="nav-item dropdown">
                    <router-link to="/dashboard" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Policies</router-link>
                </div>
                <router-link to="/dashboard" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Activities</router-link>
            </div>
        </nav>
